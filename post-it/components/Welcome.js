        ...
        <View style={[styles.container, { marginTop: -50 }]}>
          ...
          <View style={{ marginLeft: 15, marginRight: 15 }}>
            <Text style={styles.tinyText}>
              ...
              pouvoir contenir des brouillons de posts qu'un community manager
              (writter) pourra créer.
        ...
        <View style={[styles.container, { marginTop: -50 }]}>
          ...
          <View style={{ marginLeft: 15, marginRight: 15 }}>
            <Text style={styles.tinyText}>
              ...
              Rendez vous dans un de vos projets pour y créer vos premiers posts
              à faire valider !{"\n"}
