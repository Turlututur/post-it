...
const create_cypher_where_predicate_1 = require("../../where/create-cypher-where-predicate");
...
function createProjectionSubquery({ parentNode, whereInput, node, context, alias, nestedProjection, nestedSubqueries, relationField, relationshipDirection, optionsInput, authValidateStrs, }) {
    ...
    if (whereInput) {
        const wherePredicate = (0, create_cypher_where_predicate_1.createCypherWherePredicate)({
            element: node,
            context,
            whereInput,
