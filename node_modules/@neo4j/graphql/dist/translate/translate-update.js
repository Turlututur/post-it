...
const utils_1 = require("./cypher-builder/utils/utils");
async function translateUpdate({ node, context, }) {
    ...
    const topLevelMatch = (0, translate_top_level_match_1.translateTopLevelMatch)({ node, context, varName, operation: "UPDATE" });
    ...
    const updateQuery = new CypherBuilder.RawCypher((env) => {
        const projectionSubqueryStr = (0, utils_1.compileCypherIfExists)(projectionSubquery, env);
        const cypher = [
