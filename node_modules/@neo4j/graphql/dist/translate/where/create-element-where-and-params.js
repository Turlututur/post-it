...
const create_aggregate_operation_1 = require("./property-operations/create-aggregate-operation");
...
function createElementWhereAndParams({ whereInput, element, varName, context, parameterPrefix, listPredicates, }) {
    ...
    function reducer(res, [key, value]) {
        ...
        const { fieldName, operator, isAggregate } = match.groups;
        if (!fieldName) {
        ...
        if (element instanceof classes_1.Node) {
            ...
            if (isAggregate) {
                ...
                const operation = (0, create_aggregate_operation_1.createAggregateOperation)({
                    relationField,
                    context,
                    value,
                    parentNode,
