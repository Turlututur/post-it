...
exports.createWherePropertyOperation = void 0;
...
function createWherePropertyOperation({ key, value, element, targetElement, context, }) {
    ...
    if (element instanceof classes_1.Node) {
        ...
        if (coalesceValue) {
            propertyRef = CypherBuilder.coalesce(propertyRef, new CypherBuilder.Literal(coalesceValue));
        }
...
exports.createWherePropertyOperation = createWherePropertyOperation;
//# sourceMappingURL=create-where-property-operation.js.map