                ...
                updates.forEach((update, index) => {
                    ...
                    if (update.update) {
                        ...
                        if (update.update.node) {
                            ...
                            const apocArgs = `{${withVars.map((withVar) => `${withVar}:${withVar}`).join(", ")}, ${parameterPrefix?.split(".")[0]}: $${parameterPrefix?.split(".")[0]}, ${_varName}:${_varName}REPLACE_ME}`;
