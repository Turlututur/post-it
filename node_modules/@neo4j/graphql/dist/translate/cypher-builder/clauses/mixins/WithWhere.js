...
const boolean_1 = require("../../operations/boolean");
const PropertyRef_1 = require("../../PropertyRef");
const comparison_1 = require("../../operations/comparison");
class WithWhere extends ClauseMixin_1.ClauseMixin {
    ...
    createWhereInput(input, params) {
        if (input instanceof Variable_1.Variable) {
    ...
    variableAndObjectToOperation(target, params) {
        ...
        for (const [key, value] of Object.entries(params)) {
            const property = new PropertyRef_1.PropertyRef(target, key);
