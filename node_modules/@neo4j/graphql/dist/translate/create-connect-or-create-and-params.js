...
function createConnectOrCreateAndParams({ input, varName, parentVar, relationField, refNode, context, withVars, callbackBucket, }) {
    ...
    const wrappedQueries = statements.map((statement) => {
        ...
        const callStatement = new CypherBuilder.Call(CypherBuilder.concat(statement, returnStatement)).innerWith(...withVarsVariables);
...
function createConnectOrCreatePartialStatement({ input, baseName, parentVar, relationField, refNode, context, callbackBucket, }) {
