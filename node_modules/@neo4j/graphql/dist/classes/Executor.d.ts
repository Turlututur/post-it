...
export declare type ExecutionContext = Driver | Session | Transaction;
export declare type ExecutorConstructorParam = {
...
export declare class Executor {
    ...
    execute(query: string, parameters: any, defaultAccessMode: SessionMode): Promise<QueryResult>;
    private formatError;
